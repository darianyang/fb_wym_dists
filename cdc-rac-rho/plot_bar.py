...
# Example usage:
family = 'cdc'
tyr_csv_output_file = f'output_trp_to_tyr_{family}.csv'  # Output CSV for Tyr distances
met_csv_output_file = f'output_trp_to_met_{family}.csv'  # Output CSV for Met distances
